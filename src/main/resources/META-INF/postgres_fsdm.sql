...
(
    arrangementid                 character varying(255) NOT NULL,
    ...
    originalsourcesystemuniqueid  character varying(255) NOT NULL,
    activeflagid                  character varying(255) NOT NULL,
    enterpriseid                  character varying(255) NOT NULL,
    systemid                      character varying(255) NOT NULL,
    originalsourcesystemid        character varying(255) NOT NULL
);
...
(
    arrangementsecuritytokenid    character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
    ...
    enterpriseid                  character varying(255) NOT NULL,
    originalsourcesystemid        character varying(255) NOT NULL,
    securitytokenid               character varying(255) NOT NULL,
    systemid                      character varying(255) NOT NULL,
    arrangementid                 character varying(255) NOT NULL
);
...
(
    arrangementtypeid             character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
...
(
    arrangementtypesecuritytokenid character varying(255) NOT NULL,
    effectivefromdate              timestamp(6) without time zone NOT NULL,
    effectivetodate                timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp      timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp  timestamp(6) without time zone NOT NULL,
...
(
    arrangementtypexclassificationid character varying(255) NOT NULL,
    effectivefromdate                timestamp(6) without time zone NOT NULL,
    effectivetodate                  timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp        timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp    timestamp(6) without time zone NOT NULL,
...
(
    arrangementtypexclassificationsecuritytokenid character varying(255) NOT NULL,
    effectivefromdate                             timestamp(6) without time zone NOT NULL,
    effectivetodate                               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp                     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp                 timestamp(6) without time zone NOT NULL,
...
(
    arrangementxarrangementid     character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
    ...
    originalsourcesystemid        character varying(255) NOT NULL,
    classificationid              character varying(255) NOT NULL,
    childarrangementid            character varying(255) NOT NULL,
    parentarrangementid           character varying(255) NOT NULL
);
...
(
    arrangementxarrangementsecuritytokenid character varying(255) NOT NULL,
    effectivefromdate                      timestamp(6) without time zone NOT NULL,
    effectivetodate                        timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp              timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp          timestamp(6) without time zone NOT NULL,
...
(
    arrangementxarrangementtypeid character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
    ...
    originalsourcesystemid        character varying(255) NOT NULL,
    classificationid              character varying(255) NOT NULL,
    arrangementid                 character varying(255),
    arrangementtypeid             character varying(255)
);
...
(
    arrangementxarrangementtypesecuritytokenid character varying(255) NOT NULL,
    effectivefromdate                          timestamp(6) without time zone NOT NULL,
    effectivetodate                            timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp                  timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp              timestamp(6) without time zone NOT NULL,
...
(
    arrangementxclassificationid  character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
...
(
    arrangementxclassificationsecuritytokenid character varying(255) NOT NULL,
    effectivefromdate                         timestamp(6) without time zone NOT NULL,
    effectivetodate                           timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp                 timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp             timestamp(6) without time zone NOT NULL,
...
(
    arrangementxinvolvedpartyid   character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
    ...
    classificationid              character varying(255) NOT NULL,
    arrangementid                 character varying(255) NOT NULL,
    involvedpartyid               character varying(255) NOT NULL
);
...
(
    arrangementxinvolvedpartysecuritytokenid character varying(255) NOT NULL,
    effectivefromdate                        timestamp(6) without time zone NOT NULL,
    effectivetodate                          timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp                timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp            timestamp(6) without time zone NOT NULL,
...
(
    arrangementxproductid         character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
...
(
    arrangementxproductsecuritytokenid character varying(255) NOT NULL,
    effectivefromdate                  timestamp(6) without time zone NOT NULL,
    effectivetodate                    timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp          timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp      timestamp(6) without time zone NOT NULL,
...
(
    arrangementxresourceitemid    character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
    ...
    classificationid              character varying(255) NOT NULL,
    arrangementid                 character varying(255) NOT NULL,
    resourceitemid                character varying(255) NOT NULL
);
...
(
    arrangementxresourceitemsecuritytokenid character varying(255) NOT NULL,
    effectivefromdate                       timestamp(6) without time zone NOT NULL,
    effectivetodate                         timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp               timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp           timestamp(6) without time zone NOT NULL,
...
(
    arrangementxrulesid           character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
    ...
    classificationid              character varying(255) NOT NULL,
    arrangementid                 character varying(255) NOT NULL,
    rulesid                       character varying(255) NOT NULL
);
...
(
    arrangementxrulessecuritytokenid character varying(255) NOT NULL,
    effectivefromdate                timestamp(6) without time zone NOT NULL,
    effectivetodate                  timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp        timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp    timestamp(6) without time zone NOT NULL,
...
(
    arrangementxrulestypeid       character varying(255) NOT NULL,
    effectivefromdate             timestamp(6) without time zone NOT NULL,
    effectivetodate               timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp     timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp timestamp(6) without time zone NOT NULL,
    ...
    classificationid              character varying(255) NOT NULL,
    arrangementid                 character varying(255) NOT NULL,
    rulestypeid                   character varying(255) NOT NULL
);
...
(
    arrangementxrulestypesecuritytokenid character varying(255) NOT NULL,
    effectivefromdate                    timestamp(6) without time zone NOT NULL,
    effectivetodate                      timestamp(6) without time zone NOT NULL,
    warehousecreatedtimestamp            timestamp(6) without time zone NOT NULL,
    warehouselastupdatedtimestamp        timestamp(6) without time zone NOT NULL,
...
ALTER TABLE ONLY arrangement.arrangement
    ADD CONSTRAINT arrangement_pkey PRIMARY KEY (arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementsecuritytoken
    ADD CONSTRAINT arrangementsecuritytoken_pkey PRIMARY KEY (arrangementsecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementtype
    ADD CONSTRAINT arrangementtype_pkey PRIMARY KEY (arrangementtypeid);
...
ALTER TABLE ONLY arrangement.arrangementtypesecuritytoken
    ADD CONSTRAINT arrangementtypesecuritytoken_pkey PRIMARY KEY (arrangementtypesecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassification
    ADD CONSTRAINT arrangementtypexclassification_pkey PRIMARY KEY (arrangementtypexclassificationid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassificationsecuritytoken
    ADD CONSTRAINT arrangementtypexclassificationsecuritytoken_pkey PRIMARY KEY (arrangementtypexclassificationsecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangement
    ADD CONSTRAINT arrangementxarrangement_pkey PRIMARY KEY (arrangementxarrangementid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementsecuritytoken
    ADD CONSTRAINT arrangementxarrangementsecuritytoken_pkey PRIMARY KEY (arrangementxarrangementsecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtype
    ADD CONSTRAINT arrangementxarrangementtype_pkey PRIMARY KEY (arrangementxarrangementtypeid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtypesecuritytoken
    ADD CONSTRAINT arrangementxarrangementtypesecuritytoken_pkey PRIMARY KEY (arrangementxarrangementtypesecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxclassification
    ADD CONSTRAINT arrangementxclassification_pkey PRIMARY KEY (arrangementxclassificationid);
...
ALTER TABLE ONLY arrangement.arrangementxclassificationsecuritytoken
    ADD CONSTRAINT arrangementxclassificationsecuritytoken_pkey PRIMARY KEY (arrangementxclassificationsecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedparty
    ADD CONSTRAINT arrangementxinvolvedparty_pkey PRIMARY KEY (arrangementxinvolvedpartyid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedpartysecuritytoken
    ADD CONSTRAINT arrangementxinvolvedpartysecuritytoken_pkey PRIMARY KEY (arrangementxinvolvedpartysecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxproduct
    ADD CONSTRAINT arrangementxproduct_pkey PRIMARY KEY (arrangementxproductid);
...
ALTER TABLE ONLY arrangement.arrangementxproductsecuritytoken
    ADD CONSTRAINT arrangementxproductsecuritytoken_pkey PRIMARY KEY (arrangementxproductsecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitem
    ADD CONSTRAINT arrangementxresourceitem_pkey PRIMARY KEY (arrangementxresourceitemid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitemsecuritytoken
    ADD CONSTRAINT arrangementxresourceitemsecuritytoken_pkey PRIMARY KEY (arrangementxresourceitemsecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxrules
    ADD CONSTRAINT arrangementxrules_pkey PRIMARY KEY (arrangementxrulesid);
...
ALTER TABLE ONLY arrangement.arrangementxrulessecuritytoken
    ADD CONSTRAINT arrangementxrulessecuritytoken_pkey PRIMARY KEY (arrangementxrulessecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestype
    ADD CONSTRAINT arrangementxrulestype_pkey PRIMARY KEY (arrangementxrulestypeid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestypesecuritytoken
    ADD CONSTRAINT arrangementxrulestypesecuritytoken_pkey PRIMARY KEY (arrangementxrulestypesecuritytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitem
    ADD CONSTRAINT fk10auu483ou8vross23ilkm601 FOREIGN KEY (classificationid) REFERENCES classification.classification(classificationid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestypesecuritytoken
    ADD CONSTRAINT fk11a4s30v3c7vosoqpy1210fhu FOREIGN KEY (arrangementxrulestypeid) REFERENCES arrangement.arrangementxrulestype(arrangementxrulestypeid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangement
    ADD CONSTRAINT fk1evl6ld81fkqmo674i0ip26v FOREIGN KEY (parentarrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementtypesecuritytoken
    ADD CONSTRAINT fk1kek1dppp202jrr8e9f692syg FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxproduct
    ADD CONSTRAINT fk1xsuwtqoogpaxitg2wjqk2rs3 FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementsecuritytoken
    ADD CONSTRAINT fk2fi4ltyv1r2frptrof3moedig FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementsecuritytoken
    ADD CONSTRAINT fk2hmmp93bfci8j7pwlv14p7m9 FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxproductsecuritytoken
    ADD CONSTRAINT fk2mf0po3jsf10wa7ypxoyj2t0q FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedparty
    ADD CONSTRAINT fk2nbjk1qgv7xcqx60p5k9fpknv FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxrulessecuritytoken
    ADD CONSTRAINT fk33pq6ks4wh6ap23lm8cmv11e3 FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassification
    ADD CONSTRAINT fk3cu1a03o9dfjsrxdgg5f8ljc1 FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestypesecuritytoken
    ADD CONSTRAINT fk3plf0o1h097qqbme256dh14ms FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxrules
    ADD CONSTRAINT fk3q3s3y2ypar6b6yao94qiavib FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxproduct
    ADD CONSTRAINT fk3uwrmqh1e9msanm5ujxk06mqh FOREIGN KEY (productid) REFERENCES product.product(productid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementsecuritytoken
    ADD CONSTRAINT fk4b5sc95gghbab83uot4y8kma4 FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtypesecuritytoken
    ADD CONSTRAINT fk4f2d6k0rr9lafbgy0j4w59405 FOREIGN KEY (arrangementxarrangementtypeid) REFERENCES arrangement.arrangementxarrangementtype(arrangementxarrangementtypeid);
...
ALTER TABLE ONLY arrangement.arrangementtypesecuritytoken
    ADD CONSTRAINT fk4kogklx4xlk4ck1ol3nc3xuf3 FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitemsecuritytoken
    ADD CONSTRAINT fk4lwhxuk5gfc02ycby5kfro576 FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestypesecuritytoken
    ADD CONSTRAINT fk51besipwxf9c4wsjao3x1b2y1 FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestypesecuritytoken
    ADD CONSTRAINT fk533wd6s99uye7jfrvnscmp7h0 FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitem
    ADD CONSTRAINT fk5m4kptkleha73alk03p761cau FOREIGN KEY (resourceitemid) REFERENCES resource.resourceitem(resourceitemid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestypesecuritytoken
    ADD CONSTRAINT fk5m5vtq233eq18lrww0cu5isj9 FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedpartysecuritytoken
    ADD CONSTRAINT fk5nm7udu4cx5rwgqsxiy10vdmj FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangement
    ADD CONSTRAINT fk5qltxdf1yl3w935f1v6c1s3te FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxclassification
    ADD CONSTRAINT fk5rajkqbykrmn8tkkrqg2clkk1 FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangement
    ADD CONSTRAINT fk5x95ig2e720s90163vs5mru16 FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxrulessecuritytoken
    ADD CONSTRAINT fk62jqx0o1s2q6r66fn8nrjo4bf FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestype
    ADD CONSTRAINT fk6343urwgxbykoau8p7h0i58gj FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtypesecuritytoken
    ADD CONSTRAINT fk67y1klef35wuyfupagyk4roic FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestype
    ADD CONSTRAINT fk69m07mb95iafnyyk11228ihmc FOREIGN KEY (rulestypeid) REFERENCES rules.rulestype(rulestypeid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedparty
    ADD CONSTRAINT fk6c7521dhlo7ou6o4oeosk7eop FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedparty
    ADD CONSTRAINT fk6ka1ls0qmv9y1iaya2rkr8m5r FOREIGN KEY (classificationid) REFERENCES classification.classification(classificationid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestype
    ADD CONSTRAINT fk6rx9646bu0edq22qa8nol81vv FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxclassificationsecuritytoken
    ADD CONSTRAINT fk6tsk1t4h6o94591ke2oy8fcte FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxrulessecuritytoken
    ADD CONSTRAINT fk6tttie9brrhlxxh2adq02kffo FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedparty
    ADD CONSTRAINT fk71wpg1p7v2qn02lh0cw5drs95 FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementxclassificationsecuritytoken
    ADD CONSTRAINT fk7h39db92fgksv3rwgkq72hsd1 FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtypesecuritytoken
    ADD CONSTRAINT fk7y5i3hvgtvn2u9mtx8wljsh9a FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxproductsecuritytoken
    ADD CONSTRAINT fk7ychxphmo3yvikab4txsecg1h FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxproductsecuritytoken
    ADD CONSTRAINT fk82ys481oxq2v892sryshuytj0 FOREIGN KEY (arrangementxproductid) REFERENCES arrangement.arrangementxproduct(arrangementxproductid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitemsecuritytoken
    ADD CONSTRAINT fk8bgg9lfof21l7yvjet4et71xj FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementsecuritytoken
    ADD CONSTRAINT fk8h3yhvjy6fw0rvr2uyxq8voh5 FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxclassificationsecuritytoken
    ADD CONSTRAINT fk8jucexc7kuoodu11v39lpwxj9 FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementtypesecuritytoken
    ADD CONSTRAINT fk8to2ic6e1hst2vlk01q5p7cw1 FOREIGN KEY (arrangementtypeid) REFERENCES arrangement.arrangementtype(arrangementtypeid);
...
ALTER TABLE ONLY arrangement.arrangementxclassificationsecuritytoken
    ADD CONSTRAINT fk9c1o9pupbc18y3et9022u6etc FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxclassificationsecuritytoken
    ADD CONSTRAINT fk9cdguosd6bmsd6ihjueeay3qu FOREIGN KEY (arrangementxclassificationid) REFERENCES arrangement.arrangementxclassification(arrangementxclassificationid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangement
    ADD CONSTRAINT fk9g734gsx3xenay6j6aw1t11dv FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangement
    ADD CONSTRAINT fk9gnhqn13p53nkwow24uj5lllt FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementtypesecuritytoken
    ADD CONSTRAINT fk9le4bf2k6hm5nc8ieluakg4fd FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtypesecuritytoken
    ADD CONSTRAINT fk9q39hofgnynlo6lfnv57d0wn7 FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassificationsecuritytoken
    ADD CONSTRAINT fk9veykvob6op2xdb32ad53tu82 FOREIGN KEY (arrangementtypexclassificationid) REFERENCES arrangement.arrangementtypexclassification(arrangementtypexclassificationid);
...
ALTER TABLE ONLY arrangement.arrangementxclassification
    ADD CONSTRAINT fk9w31er1wt79j9n4v3ugfhb6hn FOREIGN KEY (classificationid) REFERENCES classification.classification(classificationid);
...
ALTER TABLE ONLY arrangement.arrangementtype
    ADD CONSTRAINT fkaflivu0h1pm24n5y95tw5gv1y FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxproduct
    ADD CONSTRAINT fkalyhg8tgsoumu832w7ol05mqv FOREIGN KEY (classificationid) REFERENCES classification.classification(classificationid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtype
    ADD CONSTRAINT fkb2mvoggrta8b3xlgvxav3gv68 FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtype
    ADD CONSTRAINT fkbbug6qxo424aa0l3k0ilpjwh1 FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementxrules
    ADD CONSTRAINT fkbc3k5pxxb18ylj1p929i1t740 FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtype
    ADD CONSTRAINT fkbcb78fk9imiu30j55mudj4w9l FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxclassification
    ADD CONSTRAINT fkbkgxtaag54r6vr8vyt0p6e2uu FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangement
    ADD CONSTRAINT fkbli36e1w9e3a47g2s5a5unn2n FOREIGN KEY (childarrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementsecuritytoken
    ADD CONSTRAINT fkby5vbby0hxu3nnxqjkgpg71xq FOREIGN KEY (arrangementxarrangementid) REFERENCES arrangement.arrangementxarrangement(arrangementxarrangementid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedparty
    ADD CONSTRAINT fkc3wsa0x6xjq8pt6mnp8p2390l FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxrulessecuritytoken
    ADD CONSTRAINT fkc4a0rcrpg0hotxs39ny4ki4qw FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementsecuritytoken
    ADD CONSTRAINT fkc6bmk80c5n3kl4frhnr5nsn5s FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestype
    ADD CONSTRAINT fkcnkik4eq3xs4h6v2j13ul3rsv FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestype
    ADD CONSTRAINT fkd7koulxa7fid1reyw9nyhhuts FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitem
    ADD CONSTRAINT fked04m2i7mgfyfrsxu60cmf8or FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxproduct
    ADD CONSTRAINT fked4l0kxkvvnw06uq0l4n55e35 FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtype
    ADD CONSTRAINT fkek405uwe4g6xo9tdi9gfhg88y FOREIGN KEY (arrangementtypeid) REFERENCES arrangement.arrangementtype(arrangementtypeid);
...
ALTER TABLE ONLY arrangement.arrangementxclassification
    ADD CONSTRAINT fkesqu1vwy8pm4ori8xt2hlt00y FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxproductsecuritytoken
    ADD CONSTRAINT fkf0liawyl1pg73vaqhl9077ty2 FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxrules
    ADD CONSTRAINT fkf8qlkxh19e3pedt1xmnwe786o FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassificationsecuritytoken
    ADD CONSTRAINT fkfieks9k5klxucyqm2qel3dvyk FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassificationsecuritytoken
    ADD CONSTRAINT fkfuddtuea83j0rqqy24iwxsddr FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestypesecuritytoken
    ADD CONSTRAINT fkfxhigbw4io92wri4583cu4v0l FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxrulessecuritytoken
    ADD CONSTRAINT fkgeha0vtd9yo30vppd0an8kcyp FOREIGN KEY (arrangementxrulesid) REFERENCES arrangement.arrangementxrules(arrangementxrulesid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassification
    ADD CONSTRAINT fkgqxi8s68s3xjnmr59l1mjrm3g FOREIGN KEY (classificationid) REFERENCES classification.classification(classificationid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassification
    ADD CONSTRAINT fkhasvr2i2sploam3msr9ujxvg4 FOREIGN KEY (arrangementtypeid) REFERENCES arrangement.arrangementtype(arrangementtypeid);
...
ALTER TABLE ONLY arrangement.arrangementxrulessecuritytoken
    ADD CONSTRAINT fkhf5rvmrtd7mq9vm4obo2m68eh FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassificationsecuritytoken
    ADD CONSTRAINT fkhsvu9ibj7uijfgn34h38l5nh3 FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangement
    ADD CONSTRAINT fkhyfnlmxxkjivonnw64dir0iph FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedparty
    ADD CONSTRAINT fki29w8ch3051e71mlykw6gt7p0 FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxproduct
    ADD CONSTRAINT fki2inhxddbgmsdi3bl7mwt7fqi FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitemsecuritytoken
    ADD CONSTRAINT fki6fgnt16ckmqi9y21s9a8gp47 FOREIGN KEY (arrangementxresourceitemid) REFERENCES arrangement.arrangementxresourceitem(arrangementxresourceitemid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementsecuritytoken
    ADD CONSTRAINT fkieslcpo9uox0881igyk7rdfrq FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxproduct
    ADD CONSTRAINT fkiissfi60gmgix1sr4ik8wp9fa FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitem
    ADD CONSTRAINT fkiu0pr9p6o39mwwfh9epgoahom FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementtypesecuritytoken
    ADD CONSTRAINT fkj02k0j5pke3dkpaxhbgmaikqi FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtypesecuritytoken
    ADD CONSTRAINT fkk5vha5aon2i7roy6wox5r8k1d FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxproductsecuritytoken
    ADD CONSTRAINT fkkfajnpjwfuc4kt13avqmjs27i FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangement
    ADD CONSTRAINT fkkg32gfwya6793p80k1no6hmk8 FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassificationsecuritytoken
    ADD CONSTRAINT fkko0edkl361kq6uwstfhcmp1e7 FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedparty
    ADD CONSTRAINT fkkpvqwygo5551679i6hds7kada FOREIGN KEY (involvedpartyid) REFERENCES party.involvedparty(involvedpartyid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedpartysecuritytoken
    ADD CONSTRAINT fkkyktyh5uldr0apnx4fb7rqqhj FOREIGN KEY (arrangementxinvolvedpartyid) REFERENCES arrangement.arrangementxinvolvedparty(arrangementxinvolvedpartyid);
...
ALTER TABLE ONLY arrangement.arrangementxrules
    ADD CONSTRAINT fkl1taisa4493ad6n8troarks3c FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassification
    ADD CONSTRAINT fklexxdvodllklvfn0ua4r0aw0u FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassification
    ADD CONSTRAINT fklne0s6fbh4wdnpnvija69e2d8 FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementtype
    ADD CONSTRAINT fkm3ev8du7vdvw2rislo3gxsvv9 FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxclassificationsecuritytoken
    ADD CONSTRAINT fkmxvd2rnt5882sxxk831sdbkqq FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitemsecuritytoken
    ADD CONSTRAINT fkn7ohgt9uwimsmg8b1kcclgymq FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementsecuritytoken
    ADD CONSTRAINT fkngh7orqtfcriw1bpc7ctcu9ay FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedpartysecuritytoken
    ADD CONSTRAINT fknhcqo7dtttikbygsv29vbxw64 FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementsecuritytoken
    ADD CONSTRAINT fknjnehgnp3ybq6wcnfbx6clqi8 FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementtype
    ADD CONSTRAINT fknk2gclr0bkbxp3dvg0yboy59o FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxproductsecuritytoken
    ADD CONSTRAINT fknp4l2srl6e09175ngloxrexer FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangement
    ADD CONSTRAINT fko7k9jfu2q1gdbwkhan19cjg6r FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementsecuritytoken
    ADD CONSTRAINT fkodrogs5m3dhd54wsy89161ika FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitemsecuritytoken
    ADD CONSTRAINT fkofagwms8gkw6geqmiyncnj2cx FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtype
    ADD CONSTRAINT fkofvbeuabms8ebk75wsgnkjbld FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitemsecuritytoken
    ADD CONSTRAINT fkotwjcy38jqowrom4f1t9u4sxv FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestype
    ADD CONSTRAINT fkov2gqdwxiyblbpqmnwc4np7x9 FOREIGN KEY (classificationid) REFERENCES classification.classification(classificationid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangement
    ADD CONSTRAINT fkovmdueeas3icmh2sa2j64g4ck FOREIGN KEY (classificationid) REFERENCES classification.classification(classificationid);
...
ALTER TABLE ONLY arrangement.arrangementtypesecuritytoken
    ADD CONSTRAINT fkp3x2trigpgx2f2q7h92n2tlr2 FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedpartysecuritytoken
    ADD CONSTRAINT fkp9gl2xg7lrargsi7wloadqsxa FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassificationsecuritytoken
    ADD CONSTRAINT fkpe27j1xif8mx3f5q5dh6o41an FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementtypexclassification
    ADD CONSTRAINT fkpi8wetfnfovvirlmsfvhu89bh FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitem
    ADD CONSTRAINT fkpj4eok42bmisj8g6r7crx0er5 FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitem
    ADD CONSTRAINT fkpjx2bwph3f67laisvffrnopd8 FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxclassification
    ADD CONSTRAINT fkpwmnjntxrxxp88ohtix3f9rld FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxrulestype
    ADD CONSTRAINT fkq01c7ongg1cofa4ceibxduma2 FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtypesecuritytoken
    ADD CONSTRAINT fkqi48u6i84yjq1jg357fh1qwgi FOREIGN KEY (originalsourcesystemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedpartysecuritytoken
    ADD CONSTRAINT fkqmjll31vsk7uwahn932wd5vob FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementxclassification
    ADD CONSTRAINT fkqryq2ja6bavkj7a5bj7w081kp FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxinvolvedpartysecuritytoken
    ADD CONSTRAINT fkqup67qfcgs10hc0x651xne7t9 FOREIGN KEY (securitytokenid) REFERENCES security.securitytoken(securitytokenid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtype
    ADD CONSTRAINT fkqxy44j74nhe3dhfwf595lguwl FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxrules
    ADD CONSTRAINT fkqyb5d3jb3i9rsxm0cfo208njj FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxresourceitem
    ADD CONSTRAINT fkrc9mg4osgj3ye4dab54n96ttq FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementsecuritytoken
    ADD CONSTRAINT fkrhnkn0cyirv36wdfbx81p2omn FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY arrangement.arrangementtype
    ADD CONSTRAINT fkro0fvyrds9erw2wk2s6gderhd FOREIGN KEY (enterpriseid) REFERENCES dbo.enterprise(enterpriseid);
...
ALTER TABLE ONLY arrangement.arrangementxrules
    ADD CONSTRAINT fkrt9gl1ke0yp5rgncnsr0t2x2m FOREIGN KEY (classificationid) REFERENCES classification.classification(classificationid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangementtype
    ADD CONSTRAINT fkshy3d2vx1xpatx6rnu60ag7jg FOREIGN KEY (classificationid) REFERENCES classification.classification(classificationid);
...
ALTER TABLE ONLY arrangement.arrangementxrules
    ADD CONSTRAINT fksp0nolvpdwpwmjyghyp486frp FOREIGN KEY (rulesid) REFERENCES rules.rules(rulesid);
...
ALTER TABLE ONLY arrangement.arrangementxarrangement
    ADD CONSTRAINT fksw7clyy90t99djoxclxg646im FOREIGN KEY (systemid) REFERENCES dbo.systems(systemid);
...
ALTER TABLE ONLY arrangement.arrangementxproduct
    ADD CONSTRAINT fkt25tk83urovuvrxc874cm07hh FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY arrangement.arrangementsecuritytoken
    ADD CONSTRAINT fkt5ibl9ewo11erwy04qt07riv3 FOREIGN KEY (activeflagid) REFERENCES dbo.activeflag(activeflagid);
...
ALTER TABLE ONLY event.eventxarrangement
    ADD CONSTRAINT fk7607u935wf0x8yuf84h0xseyl FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
ALTER TABLE ONLY rules.rulesxarrangement
    ADD CONSTRAINT fk9gfetl178gc0bjfak6tny0keu FOREIGN KEY (arrangementid) REFERENCES arrangement.arrangement(arrangementid);
...
-- Completed on 2022-06-01 11:22:13
