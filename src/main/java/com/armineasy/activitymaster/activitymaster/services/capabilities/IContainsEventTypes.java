...
/*
	...
	@CacheResult
	default Optional<Q> findType(@CacheKey EventType type, @CacheKey UUID... identityToken)
	{
...
/*
	...
	@SuppressWarnings("unchecked")
	default Q addEventType(IEventTypeValue<?> typeValue, ISystems originatingSystems, IClassificationValue<?> classificationValue,
	                       String value, UUID... identifyingToken)
	{
		...
		Classification clazz = (Classification) get(IClassificationService.class).find(classificationValue, originatingSystems.getEnterpriseID(), identifyingToken);
		if (exists.isEmpty())
		{
	...
	//void setMyEventTypeLinkValue(Q classificationLink, S identificationType, IEnterprise<?> enterprise);
