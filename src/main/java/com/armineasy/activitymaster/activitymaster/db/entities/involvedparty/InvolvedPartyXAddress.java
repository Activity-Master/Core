		...
		extends WarehouseClassificationRelationshipTable<InvolvedParty, Address, InvolvedPartyXAddress, InvolvedPartyXAddressQueryBuilder, Long, InvolvedPartyXAddressSecurityToken>
{
	...
	@Override
	protected InvolvedPartyXAddressSecurityToken configureDefaultsForNewToken(InvolvedPartyXAddressSecurityToken stAdmin, Enterprise enterprise, Systems activityMasterSystem)
	{
