		...
		extends WarehouseClassificationRelationshipTable<Event, ResourceItem, EventXResourceItem, EventXResourceItemQueryBuilder, Long, EventXResourceItemSecurityToken>
{
	...
	@Override
	protected EventXResourceItemSecurityToken configureDefaultsForNewToken(EventXResourceItemSecurityToken stAdmin, Enterprise enterprise, Systems activityMasterSystem)
	{
