...
import com.armineasy.activitymaster.activitymaster.db.entities.arrangement.builders.ArrangementSecurityTokenQueryBuilder;
 ...
 */
@Entity
@Table(name = "ArrangementSecurityToken")
@XmlRootElement
		...
		implements Serializable
{
	...
	public boolean equals(final Object o)
	{
		...
		if (!(o instanceof ArrangementSecurityToken))
		{
			return false;
		}
		final ArrangementSecurityToken other = (ArrangementSecurityToken) o;
	...
	{
		return other instanceof ArrangementSecurityToken;
	}
