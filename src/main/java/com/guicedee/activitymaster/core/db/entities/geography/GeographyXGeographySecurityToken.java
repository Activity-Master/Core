...
import com.guicedee.activitymaster.core.db.entities.geography.builders.GeographyXGeographySecurityTokenQueryBuilder;
...
public class GeographyXGeographySecurityToken
		extends WarehouseSecurityTable<GeographyXGeographySecurityToken, GeographyXGeographySecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	public GeographyXGeographySecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
