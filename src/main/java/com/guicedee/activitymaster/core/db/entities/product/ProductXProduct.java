		...
		implements Serializable
{
	...
	@Override
	protected ProductXProductSecurityToken configureDefaultsForNewToken(ProductXProductSecurityToken stAdmin, ISystems<?> enterprise, ISystems<?> activityMasterSystem)
	{
