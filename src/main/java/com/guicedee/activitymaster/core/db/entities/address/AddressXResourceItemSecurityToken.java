...
import com.guicedee.activitymaster.core.db.entities.address.builders.AddressXResourceItemSecurityTokenQueryBuilder;
...
public class AddressXResourceItemSecurityToken
		extends WarehouseSecurityTable<AddressXResourceItemSecurityToken, AddressXResourceItemSecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	public AddressXResourceItemSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
