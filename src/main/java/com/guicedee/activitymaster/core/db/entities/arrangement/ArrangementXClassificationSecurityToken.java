...
import com.guicedee.activitymaster.core.db.entities.arrangement.builders.ArrangementXClassificationSecurityTokenQueryBuilder;
...
public class ArrangementXClassificationSecurityToken
		extends WarehouseSecurityTable<ArrangementXClassificationSecurityToken, ArrangementXClassificationSecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	public ArrangementXClassificationSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
	...
	public boolean equals(final Object o)
	{
		...
		if (!(o instanceof ArrangementXClassificationSecurityToken))
		{
			return false;
		}
