				                                                ...
				                                                IRules<?>, IInvolvedParty<?>>
{
	...
	@Override
	protected RulesXInvolvedPartySecurityToken configureDefaultsForNewToken(RulesXInvolvedPartySecurityToken stAdmin, IEnterprise<?> enterprise, ISystems<?> activityMasterSystem)
	{
