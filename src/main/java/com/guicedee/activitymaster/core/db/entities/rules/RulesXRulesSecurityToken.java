...
public class RulesXRulesSecurityToken
		extends WarehouseSecurityTable<RulesXRulesSecurityToken, RulesXRulesSecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	@Column(nullable = false,
			name = "RulesXRulesSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	...
	public RulesXRulesSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
