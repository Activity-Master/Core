						                                                ...
						                                                >
{
	...
	@Override
	protected InvolvedPartyXRulesSecurityToken configureDefaultsForNewToken(InvolvedPartyXRulesSecurityToken stAdmin, IEnterprise<?> enterprise, ISystems<?> activityMasterSystem)
	{
