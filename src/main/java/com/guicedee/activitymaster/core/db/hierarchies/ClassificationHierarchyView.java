...
import com.guicedee.activitymaster.core.db.hierarchies.builders.ClassificationHierarchyViewQueryBuilder;
		...
		implements Serializable
{
	...
	public ClassificationHierarchyView setId(UUID id)
	{
		this.id = id;
		return this;
	}
