...
import com.guicedee.activitymaster.core.db.entities.involvedparty.builders.InvolvedPartyXProductTypeSecurityTokenQueryBuilder;
 ...
 */
@Entity
@Table(schema="Party",name = "InvolvedPartyXProductTypeSecurityToken")
@XmlRootElement
		...
		implements Serializable
{
	...
	@Column(nullable = false,
			name = "InvolvedPartyXProductTypeSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	private UUID id;
