...
import com.guicedee.activitymaster.core.db.entities.rules.builders.RulesTypeXResourceItemSecurityTokenQueryBuilder;
		...
		implements Serializable
{
	...
	@Column(nullable = false,
			name = "RulesTypeXResourceItemSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	private UUID id;
