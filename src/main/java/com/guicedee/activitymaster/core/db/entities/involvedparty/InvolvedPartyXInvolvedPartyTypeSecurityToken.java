...
import com.guicedee.activitymaster.core.db.entities.involvedparty.builders.InvolvedPartyXInvolvedPartyTypeSecurityTokenQueryBuilder;
...
public class InvolvedPartyXInvolvedPartyTypeSecurityToken
		extends WarehouseSecurityTable<InvolvedPartyXInvolvedPartyTypeSecurityToken, InvolvedPartyXInvolvedPartyTypeSecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	public InvolvedPartyXInvolvedPartyTypeSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
