...
import com.guicedee.activitymaster.core.db.entities.events.builders.EventXResourceItemSecurityTokenQueryBuilder;
		...
		extends WarehouseSecurityTable<EventXResourceItemSecurityToken, EventXResourceItemSecurityTokenQueryBuilder, java.util.UUID>
{
	...
	@Column(nullable = false,
			name = "EventXResourceItemSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	...
	public EventXResourceItemSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
