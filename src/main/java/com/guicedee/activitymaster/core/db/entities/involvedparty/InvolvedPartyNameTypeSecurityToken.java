...
public class InvolvedPartyNameTypeSecurityToken
		extends WarehouseSecurityTable<InvolvedPartyNameTypeSecurityToken, InvolvedPartyNameTypeSecurityTokenQueryBuilder, java.util.UUID>
{
	...
	@Column(nullable = false,
			name = "InvolvedPartyNameTypeSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	...
	public InvolvedPartyNameTypeSecurityToken(UUID involvedPartyNameTypeSecurityTokenID)
	{
	...
	public InvolvedPartyNameTypeSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
