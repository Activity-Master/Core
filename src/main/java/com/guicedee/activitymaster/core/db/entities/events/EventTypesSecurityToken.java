...
public class EventTypesSecurityToken
		extends WarehouseSecurityTable<EventTypesSecurityToken, EventTypeSecurityTokenQueryBuilder, java.util.UUID>
{
	...
	@Column(nullable = false,
			name = "EventTypesSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	...
	public EventTypesSecurityToken(UUID eventTypesSecurityTokenID)
	{
	...
	public EventTypesSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
