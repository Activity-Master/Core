...
import com.guicedee.activitymaster.core.db.entities.resourceitem.builders.ResourceItemDataSecurityTokenQueryBuilder;
...
public class ResourceItemDataSecurityToken
		extends WarehouseSecurityTable<ResourceItemDataSecurityToken, ResourceItemDataSecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	public ResourceItemDataSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
