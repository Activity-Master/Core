...
import com.guicedee.activitymaster.core.db.entities.classifications.builders.ClassificationXClassificationSecurityTokenQueryBuilder;
...
public class ClassificationXClassificationSecurityToken
		extends WarehouseSecurityTable<ClassificationXClassificationSecurityToken, ClassificationXClassificationSecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	public ClassificationXClassificationSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
