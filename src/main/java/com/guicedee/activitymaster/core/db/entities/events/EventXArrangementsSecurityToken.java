...
public class EventXArrangementsSecurityToken
		extends WarehouseSecurityTable<EventXArrangementsSecurityToken, EventXArrangementSecurityTokenQueryBuilder, java.util.UUID>
{
	...
	public EventXArrangementsSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
