...
import com.guicedee.activitymaster.core.db.entities.involvedparty.builders.InvolvedPartySecurityTokenQueryBuilder;
...
public class InvolvedPartySecurityToken
		extends WarehouseSecurityTable<InvolvedPartySecurityToken, InvolvedPartySecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	public InvolvedPartySecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
