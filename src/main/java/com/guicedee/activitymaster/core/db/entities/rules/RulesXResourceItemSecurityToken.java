...
public class RulesXResourceItemSecurityToken
		extends WarehouseSecurityTable<RulesXResourceItemSecurityToken, RulesXResourceItemSecurityTokenQueryBuilder, Long>
		implements Serializable
{
	...
	public RulesXResourceItemSecurityToken(Long rulesXResourceItemSecurityTokenID)
	{
	...
	public RulesXResourceItemSecurityToken setId(Long id)
	{
		this.id = id;
		return this;
	}
