...
import com.guicedee.activitymaster.core.db.entities.events.builders.EventXAddressSecurityTokenQueryBuilder;
		...
		extends WarehouseSecurityTable<EventXAddressSecurityToken, EventXAddressSecurityTokenQueryBuilder, java.util.UUID>
{
	...
	@Column(nullable = false,
			name = "EventXAddressSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	...
	public EventXAddressSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
