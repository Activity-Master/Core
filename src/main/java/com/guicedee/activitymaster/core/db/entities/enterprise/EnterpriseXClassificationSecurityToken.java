...
public class EnterpriseXClassificationSecurityToken
		extends WarehouseSecurityTable<EnterpriseXClassificationSecurityToken, EnterpriseXClassificationSecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	@Column(nullable = false,
			name = "EnterpriseXClassificationSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	...
	public EnterpriseXClassificationSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
