...
import com.guicedee.activitymaster.core.db.entities.events.builders.EventXGeographySecurityTokenQueryBuilder;
...
public class EventXGeographySecurityToken
		extends WarehouseSecurityTable<EventXGeographySecurityToken, EventXGeographySecurityTokenQueryBuilder, java.util.UUID>
{
	...
	@Column(nullable = false,
			name = "EventXGeographySecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	...
	public EventXGeographySecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
