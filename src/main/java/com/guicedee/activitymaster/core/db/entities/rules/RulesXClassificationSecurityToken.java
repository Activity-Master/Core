...
public class RulesXClassificationSecurityToken
		extends WarehouseSecurityTable<RulesXClassificationSecurityToken, RulesXClassificationSecurityTokenQueryBuilder, Long>
		implements Serializable
{
	...
	public RulesXClassificationSecurityToken(Long rulesXClassificationSecurityTokenID)
	{
	...
	public RulesXClassificationSecurityToken setId(Long id)
	{
		this.id = id;
		return this;
	}
