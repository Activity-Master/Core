...
import com.guicedee.activitymaster.core.db.entities.rules.builders.RulesXClassificationSecurityTokenQueryBuilder;
...
public class RulesXClassificationSecurityToken
		extends WarehouseSecurityTable<RulesXClassificationSecurityToken, RulesXClassificationSecurityTokenQueryBuilder, java.util.UUID>
		implements Serializable
{
	...
	@Column(nullable = false,
			name = "RulesXClassificationSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	...
	public RulesXClassificationSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
