...
import com.guicedee.activitymaster.core.db.entities.rules.builders.RulesXProductSecurityTokenQueryBuilder;
...
public class RulesXProductSecurityToken
		extends WarehouseSecurityTable<RulesXProductSecurityToken, RulesXProductSecurityTokenQueryBuilder, java.util.UUID>
{
	...
	public RulesXProductSecurityToken setId(java.util.UUID id)
	{
		this.id = id;
		return this;
	}
