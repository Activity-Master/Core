...
import com.guicedee.activitymaster.core.db.entities.arrangement.builders.ArrangementXRulesSecurityTokenQueryBuilder;
		...
		implements Serializable
{
	...
	@Column(nullable = false,
			name = "ArrangementXRulesSecurityTokenID")@org.hibernate.annotations.Type(type = "uuid-char")
	private UUID id;
