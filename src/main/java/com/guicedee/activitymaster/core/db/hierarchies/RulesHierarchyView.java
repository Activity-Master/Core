...
import com.guicedee.activitymaster.core.db.hierarchies.builders.RulesHierarchyViewQueryBuilder;
		...
		implements Serializable
{
	...
	public RulesHierarchyView setId(UUID id)
	{
		this.id = id;
		return this;
	}
