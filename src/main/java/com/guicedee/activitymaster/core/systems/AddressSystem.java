		...
		implements IActivityMasterSystem<AddressSystem>
{
	...
	private void createDefaultTelephones(IEnterprise<?> enterprise, IActivityMasterProgressMonitor progressMonitor)
	{
		...
		service.create(AddressClassifications.Address, system);
		service.create(ContactAddress, system,AddressClassifications.Address);
		service.create(PostalAddress, system,AddressClassifications.Address);
		service.create(CallAddress, system,AddressClassifications.Address);
		service.create(InternetAddress, system,AddressClassifications.Address);
		service.create(LocationAddress, system,AddressClassifications.Address);

		service.create(AddressHomeTelephoneClassifications.HomeTelephoneNumber, system,CallAddress);
		...
		service.create(AddressHomeFaxClassifications.HomeFaxNumber, system,ContactAddress);
		...
		service.create(AddressHomeCellClassifications.HomeCellNumber, system,CallAddress);
		...
		service.create(AddressHomePagerClassifications.HomePagerNumber, system,ContactAddress);
		...
		service.create(AddressOfficeTelepehoneClassifications.OfficeTelephoneNumber, system,CallAddress);
		...
		service.create(AddressOfficeFaxClassifications.OfficeFaxNumber, system,ContactAddress);
		...
		service.create(AddressOfficeCellClassifications.OfficeCellNumber, system,CallAddress);
		...
		service.create(AddressOfficePagerClassifications.OfficePagerNumber, system,ContactAddress);
	...
	private void createDefaultInternetAddresses(IEnterprise<?> enterprise, IActivityMasterProgressMonitor progressMonitor)
	{
		...
		service.create(AddressInternalSystemClassifications.InternalAddress, system,InternetAddress);
		...
		service.create(AddressRemoteSystemClassifications.RemoteAddress, system,InternetAddress);
		...
		service.create(AddressLocalSystemClassifications.LocalAddress, system,InternetAddress);
		...
		service.create(AddressExternalSystemClassifications.ExternalAddress, system,InternetAddress);
		...
		service.create(AddressEmailClassifications.EmailAddress, system,ContactAddress);
		...
		service.create(AddressWebClassifications.WebAddress, system,InternetAddress);
	...
	private void createDefaultPhysicalAddresses(IEnterprise<?> enterprise, IActivityMasterProgressMonitor progressMonitor)
	{
		...
		service.create(AddressBuildingClassifications.BuildingAddress, system,LocationAddress);
		...
		service.create(AddressBoxClassifications.BoxAddress, system,PostalAddress);
		...
		service.create(AddressLegalClassifications.LegalAddress, system,PostalAddress);
