		...
		implements IActivityMasterSystem<ClassificationsDataConceptSystem>
{
	...
	public void createDefaults(IEnterprise<?,?> enterprise)
	{
		...
		createDefaultConcepts();
		createActiveFlagConcepts();

		createAddressConcepts();
		createArrangementConcepts();
		createClassificationsConcepts();
		createInvolvedPartyConcepts();
		createEventsConcepts();
		createProductConcepts();
		createGeographyConcepts();
		createResourceItemConcepts();
	...
	private void createArrangementConcepts()
	{
