...
public class Passwords
{
	...
	private static final int ASCII_OFFSET = Integer.parseInt(System.getProperty("ascii.offset", "26"));
	...
	public String integerEncrypt(byte[] finalPasswordAfterHash)
	{
		...
		{
			ints[n] = (int) (finalPasswordAfterHash[n]) + ASCII_OFFSET;
		}
	...
	public byte[] integerDecrypt(String input)
	{
		...
		byte[] returnable = new byte[bytes.size()];
		for (int i = 0; i < returnable.length; i++)
		{
			returnable[i] = bytes.get(i);
		}
		return returnable;
	}
