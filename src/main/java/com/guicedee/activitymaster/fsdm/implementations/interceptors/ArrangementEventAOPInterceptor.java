...
import com.guicedee.activitymaster.fsdm.client.services.annotations.ArrangementEvent;
import com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement;
import com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.events.IEvent;
import com.guicedee.activitymaster.fsdm.client.types.annotations.Arrangement;
...
public class ArrangementEventAOPInterceptor implements MethodInterceptor
{
	...
	public Object invoke(MethodInvocation methodInvocation) throws Throwable
	{
		...
		ArrangementEvent event = methodInvocation.getMethod()
		...
		for (Pair<Arrangement, IArrangement<?, ?>> pair : refObject)
		{
			...
			this.event.addArrangement(pair.getValue(), classification, event.classificationName(), getISystem(ActivityMasterSystemName), getISystemToken(ActivityMasterSystemName));
		}
