...
import com.guicedee.activitymaster.fsdm.client.services.builders.ICoreEntity;
        ...
        implements ICoreEntity<J, Q, I>
{
    ...
    {
        return Optional.ofNullable(builder().find(id).get().log().await().atMost(Duration.of(1, ChronoUnit.MINUTES)));
    }
    ...
    public Uni<J> delete()
    {
        return ((QueryBuilderCore) builder())
                .delete(this);
    }
