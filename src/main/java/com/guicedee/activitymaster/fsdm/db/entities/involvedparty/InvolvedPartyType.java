...
public class InvolvedPartyType
        extends WarehouseSCDTable<InvolvedPartyType, InvolvedPartyTypeQueryBuilder, UUID, InvolvedPartyTypeSecurityToken>
        implements IInvolvedPartyType<InvolvedPartyType, InvolvedPartyTypeQueryBuilder>,
        IWarehouseNameAndDescriptionTable<InvolvedPartyType, InvolvedPartyTypeQueryBuilder, UUID>
{
