...
public class InvolvedPartyNameType
        extends WarehouseSCDTable<InvolvedPartyNameType, InvolvedPartyNameTypeQueryBuilder, UUID, InvolvedPartyNameTypeSecurityToken>
        implements IInvolvedPartyNameType<InvolvedPartyNameType, InvolvedPartyNameTypeQueryBuilder>,
        IWarehouseNameAndDescriptionTable<InvolvedPartyNameType, InvolvedPartyNameTypeQueryBuilder, UUID>
