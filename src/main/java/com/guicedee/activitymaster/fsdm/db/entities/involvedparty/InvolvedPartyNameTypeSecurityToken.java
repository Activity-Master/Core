...
public class InvolvedPartyNameTypeSecurityToken
		extends WarehouseSecurityTable<InvolvedPartyNameTypeSecurityToken, InvolvedPartyNameTypeSecurityTokenQueryBuilder, UUID>
{
	...
	public InvolvedPartyNameTypeSecurityToken setId(UUID id)
	{
		this.id = id;
		return this;
	}
