...
public class Product
        extends WarehouseSCDTable<Product, ProductQueryBuilder, UUID, ProductSecurityToken>
        implements IProduct<Product, ProductQueryBuilder>,
        IWarehouseNameAndDescriptionTable<Product, ProductQueryBuilder, UUID>
{
    @Serial
    ...
    public Product(UUID id, String productName, String productDesc, String productCode)
    {
        this.id = id;
        name = productName;
